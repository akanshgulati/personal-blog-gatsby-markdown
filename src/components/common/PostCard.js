    ...
    return (
        <Link to={url} className="post-card">
            ...
            <div className="post-card-content">
                {post.frontmatter.tags && <span className="post-card-tags">{post.frontmatter.tags[0].frontmatter.name}</span>}
                ...
                <footer className="post-card-footer">
                    <div className="post-card-footer-left">
                        ...
                        <span className="post-card-author-name">{ post.frontmatter.author.frontmatter.name }</span>
                    </div>
                    <div className="post-card-footer-right">
                        <div className="post-reading-time">{readingTime}</div>
                    </div>
                </footer>
            </div>
        </Link>
